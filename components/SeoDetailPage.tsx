...
export default function SeoDetailPage() {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#roadmap" className="gradient-bg text-white px-7 py-3.5 rounded-xl font-semibold text-base hover:opacity-90 hover:-translate-y-0.5 transition-all shadow-lg">
                Audit my website
              </a>
      ...
      <section id="roadmap" className="py-24 px-6 bg-gray-50 dark:bg-[#0d0d15]">
