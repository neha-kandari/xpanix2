          ...
          <AnimateOnScroll>
            <div className="relative overflow-hidden rounded-[2rem] bg-white dark:bg-[#131320] border border-gray-200 dark:border-gray-800 p-12 md:p-20 text-center">
              ...
              <div className="relative flex flex-col sm:flex-row items-center justify-center gap-3">
                <a
                  href="/#contact"
                  className="gradient-bg text-white px-8 py-3.5 rounded-full font-semibold text-base hover:opacity-90 hover:-translate-y-0.5 transition-all shadow-lg"
                >
                  Start Your Project
                </a>
                <a
                  href="/portfolio"
                  className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 border border-gray-200 dark:border-gray-700 px-8 py-3.5 rounded-full font-semibold text-base hover:border-[#764ba2] hover:text-[#764ba2] hover:-translate-y-0.5 transition-all"
                >
                  See Our Work
                </a>
              </div>
