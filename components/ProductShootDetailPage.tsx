...
export default function ProductShootDetailPage() {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto grid lg:grid-cols-3 gap-12 items-start">
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a href="#works" className="gradient-bg text-white px-7 py-3.5 rounded-xl font-semibold text-base hover:opacity-90 hover:-translate-y-0.5 transition-all shadow-lg">
                See recent works
              </a>
      ...
      {/* gear brands band */}
      <section className="py-12 px-6 bg-white dark:bg-[#0a0a0f] border-y border-gray-100 dark:border-gray-800/60">
          ...
          <AnimateOnScroll>
            <div className="relative overflow-hidden rounded-[2rem] gradient-bg p-12 md:p-20 text-center text-white shadow-2xl">
              ...
              <div className="relative flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="/#contact" className="bg-white text-gray-900 px-8 py-3.5 rounded-full font-semibold text-base hover:bg-gray-100 hover:-translate-y-0.5 transition-all shadow-lg">
                  Book Your Shoot Now
                </a>
                <a href="/#contact" className="border-2 border-white/60 text-white px-8 py-3.5 rounded-full font-semibold text-base hover:bg-white/10 hover:-translate-y-0.5 transition-all">
