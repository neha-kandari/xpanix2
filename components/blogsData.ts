...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "list", items: ["Batch 4–6 genuinely different angles per testing cycle", "Judge on thumb-stop rate and hold rate before CPA", "Kill losers fast, but give the algorithm 3–4 days of signal", "Rebuild winners into new formats before they fatigue"] },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "p", text: "If your site is product-first — custom interactions, dashboards, e-commerce logic, integrations, or performance as a competitive edge — a Next.js build gives you complete control. There's no plugin ceiling, no theme constraints, and Core Web Vitals scores that templated stacks struggle to match." },
